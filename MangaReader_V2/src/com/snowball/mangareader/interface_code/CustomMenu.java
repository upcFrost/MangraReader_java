...
public class CustomMenu {
	...
	public synchronized void show(View v) {
		...
		View mView= mLayoutInflater.inflate(R.layout.options_menu, null);
        ...
        TableLayout table = (TableLayout)mView.findViewById(R.id.options_menu_table);
        ...
        for (int i=0; i < mRows; i++) {
    		...
    		for (int j=0; j< divisor; j++) {
    			...
    			View itemLayout = mLayoutInflater.inflate(R.layout.options_menu_item, null);
    			tv = (TextView)itemLayout.findViewById(R.id.options_menu_item_caption);
    			tv.setText(cmi.getCaption());
    			iv = (ImageView)itemLayout.findViewById(R.id.options_menu_item_icon);
